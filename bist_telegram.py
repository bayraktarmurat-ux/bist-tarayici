...
HISSELER = [
    ...
    "TCELL","TDGYO","TEKTU","TEZOL","TGSAS","THYAO","TKFEN","TKNSA",
...
def main():
    ...
    if len(sinyaller) == 0:
        ...
        print("Sinyal yok, bildirim gonderildi.")
        return

    # Her sinyal için ayrı mesaj gönder (çok uzun olmasın)
    ...
    for s in sinyaller:
        ...
        telegram_gonder(mesaj)
        print("Sinyal gonderildi:", s["hisse"])
